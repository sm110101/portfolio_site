...
* [X] Improve website formatting
* [X] Correct typos/poor writing on all pages

**12-13-2024**

* [X] Quadruple check project guidelines to ensure proper adherence
* [X] Finish first draft of report
* [X] Outline plan for report (build out structure, collect meaningful img/assets)
